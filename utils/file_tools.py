...
from utils.prompts import (
    ...
    WRITE_FILE_TO_DISK_DESCRIPTION,
)
...
@tool(description=WRITE_FILE_TO_DISK_DESCRIPTION, parse_docstring=True)
def write_file_to_disk(
    file_path: str,
    content: str,
) -> str:
    """Write content directly to the physical filesystem on disk.

    Args:
        file_path: Path where the file should be created/overwritten on disk
